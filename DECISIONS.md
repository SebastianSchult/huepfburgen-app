...
This repository is the Angular/Firebase Huepfburgen app. The React/Fastify/PostgreSQL SaaS architecture notes now stored in `docs/legacy-other-projects/react-fastify-postgresql-saas/` are not the source of truth for this project.
...
- The legacy SaaS documentation should be ignored for implementation planning unless it is explicitly migrated or removed.
